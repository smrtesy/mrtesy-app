...
const heContent = {
  ...
  sections: [
    {
      heading: "1. מי אנחנו",
      body: `smrtesy הוא כלי AI אישי שפותח על ידי מאור ("אנחנו", "השירות"), זמין בכתובת app.smrtesy.com.`,
    },
    {
      heading: "2. המידע שאנו אוספים",
      body: `אנו אוספים את המידע הבא:
• פרטי חשבון: שם, כתובת דוא"ל ותמונת פרופיל מגוגל כאשר מתחברים עם Google OAuth.
• נתוני שימוש: פעולות בשירות, העדפות ומשימות שנוצרו.
• נתוני Google: גישה לתיבת דואר נכנס, יומן ו-Drive בהתאם להרשאות שניתנו — לצורך יצירת משימות, סיכומים ועיבוד אוטומטי בלבד.
...
• הפעלת השירות והצגת הממשק האישי.
• עיבוד מיילים, אירועי יומן וקבצים ליצירת משימות ותובנות.
• שיפור השירות ואבחון תקלות.
• שליחת הודעות מערכת חיוניות (אין שיווק ללא הסכמה מפורשת).`,
    },
    {
      heading: "4. שיתוף מידע עם צדדים שלישיים",
      body: `איננו מוכרים את המידע. אנו משתפים מידע רק עם:
...
• Google LLC — לצורך OAuth וגישה לנתונים שהורשו.
אין שיתוף נתונים לצרכי פרסום.`,
    },
    {
      heading: "5. אחסון ואבטחה",
      body: `הנתונים מאוחסנים בשרתים של Supabase הממוקמים באיחוד האירופי. אנו מיישמים הצפנה בשידור (TLS) ובאחסון. נתונים נשמרים כל עוד החשבון פעיל ונמחקים תוך 30 יום ממועד סגירתו לפי בקשה.`,
    },
    {
      heading: "6. זכויותיכם",
      body: `יש לכם זכות לגשת לנתוניכם, לתקן נתונים שגויים, למחוק את החשבון וכל הנתונים הקשורים אליו, ולייצא את הנתונים שלכם.
לפניות: ${CONTACT_EMAIL}`,
    ...
    },
    {
      ...
      body: `נודיע על שינויים מהותיים בדוא"ל או בהודעה בממשק לפחות 14 ימים מראש. המשך השימוש מהווה הסכמה.`,
    },
    {
      heading: "9. יצירת קשר",
  ...
  sections: [
    {
      ...
      body: `smrtesy is a personal AI tool developed by Maor ("we", "the Service"), available at app.smrtesy.com.`,
    },
    {
...
No data sharing for advertising purposes.`,
    ...
    },
    {
      ...
      body: `You have the right to access your personal data, correct inaccurate data, delete your account and all associated data, and export your data.
Contact us: ${CONTACT_EMAIL}`,
    ...
    },
    {
      ...
      body: `We will notify you of material changes via email or in-app notice at least 14 days in advance. Continued use constitutes acceptance.`,
    },
    {
      heading: "9. Contact",
