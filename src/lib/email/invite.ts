...
export async function sendInviteEmail({
  ...
  const body = isHe
    ? `<div dir="rtl" style="font-family:sans-serif;max-width:480px;margin:0 auto">
        ...
        <a href="${escapeHtml(inviteUrl)}" style="display:inline-block;padding:12px 24px;background:#534AB7;color:#fff;text-decoration:none;border-radius:6px;margin:16px 0">
          אשר הזמנה
        </a>
