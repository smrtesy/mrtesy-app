...
| #1 | סלקטיביות: זיו מול מנוע מול אקראי | `validation/ziv-selection/ziv_selection_test.py` | `ziv-selection/RESULTS.md` | v1 (כניסה-בשוק) הושלם — **קונפאונד**: 59/62 פסקי-זיו הם "חכה-לפולבק", v2 נדרש |
